...
var common_splitPageHead = function() {
    ...
    var splitPageHtml = function(divId, formId, totalRow, pageSize, pageNumber, totalPages, isSelectPage, isSelectSize, orderColunm, orderMode, currentPageCount){
        ...
        splitStr += '<div class="dataTables_paginate paging_bootstrap" style="float:left">';
        ...
        //}
        //<label>
        //<select name="datatableyxin2_length" aria-controls="datatableyxin2" class="form-control input-sm">
        //    <option value="10">10</option><option value="25">25</option>
        //<option value="50">50</option><option value="100">100</option>
        //</select> records per page<iframe id="tmp_downloadhelper_iframe" style="display: none;"></iframe></label>
